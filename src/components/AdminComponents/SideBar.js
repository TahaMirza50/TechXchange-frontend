...
const SideBar = (props) => {
   ...
   <div class="h-full rounded-r px- py-4 overflow-y-auto bg-blue-100 dark:bg-gray-800">
      <ul class="space-y-2 font-medium">
         ...
         <li>
            <Link to="advertisements" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
         ...
         <li>
            <Link to="reports" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
