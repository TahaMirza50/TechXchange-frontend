...
const ProfilePage = () => {
    ...
    const renderStar = (num) => {
        ...
        for (let i = 1; i <= 5; i++) {
            ...
            stars.push(
                <svg class={`w-4 h-4 ${starColor} me-1`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
        ...
        <div>
            ...
            <div className="flex mx-28 my-10 flex-col gap-10">
                ...
                <div className="w-full flex flex-row rounded-xl bg-gray-200 mb-10 py-10 px-10">
                    <div className="w-1/3">
                        <svg class="mx-16 my-5 text-blue-900 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M10 0a10 10 0 1 0 10 10A10.011 10.011 0 0 0 10 0Zm0 5a3 3 0 1 1 0 6 3 3 0 0 1 0-6Zm0 13a8.949 8.949 0 0 1-4.951-1.488A3.987 3.987 0 0 1 9 13h2a3.987 3.987 0 0 1 3.951 3.512A8.949 8.949 0 0 1 10 18Z" />
                        </svg>
                        <h4 class="text-2xl font-bold dark:text-white text-center">{user.firstName + " " + user.lastName}</h4>
                    </div>
                    <div className="w-2/3 m-9 dark:text-white">
                        <h6 class="text-lg font-bold">Address</h6>
                        <p className="pb-5">{profile.address}</p>
                        <div className="flex w-full pb-5 flex-row">
                            <div className="w-1/2">
                                <h6 class="text-lg font-bold">CNIC</h6>
                                <p>{profile.CNIC}</p>
                            </div>
                            <div className="w-1/2">
                                <h6 class="text-lg font-bold">Contact No.</h6>
                                <p>{profile.contact}</p>
                            </div>
                        </div>
                        ...
                        {profile.rating === null
                            ...
                            : <div className="flex pb-5 flex-row items-center">
                                {renderStar(profile.rating)}
                                <p>{profile.rating} ({profile.numberOfReviews})</p>
                            </div>
                        }
                        <h6 class="text-lg font-bold">Social Media</h6>
                        <div className="flex flex-col">
                        {profile.socialMediaLinks && profile.socialMediaLinks.map((link) => 
